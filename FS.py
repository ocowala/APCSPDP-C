...
def output_color_possible_cards(possible_cards):
    new_possible_cards = []
...
def main():
    ...
    print("\t3. HAVE FUN!\n")
    print("\t\t\033[0;31;48mSIMULATION\033[0m\n\n\n")
    time.sleep(3)
    suits = ['♥', '♦', '♣', '♠']
    ...
    print(f"PLAYER FIRST TO GO: ROBOT {idx_first + 1}")
    print()
    #print(player_list[0])
    ...
    while True:
        ...
        print(f"ROBOT {idx_first + 1} DEALT {color_output_card(card)}")
